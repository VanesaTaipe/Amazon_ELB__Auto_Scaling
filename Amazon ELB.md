...
* Si el balanceador de carga con dos servidores web, y acceder al balanceador de carga 4 veces, por lo tanto, el servidor web 1 atendió 2 solicitudes y el servidor web 2  atiendo 2 solicitudes.
